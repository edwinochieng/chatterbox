    ...
    <div className="max-h-screen bg-primary">
      <div className="h-full w-full ">
        <div className="mt-5 px-6">
          <h1 className="text-3xl font-semibold ">Add Friends</h1>
              ...
              {searchResult ? (
                <div className="flex flex-row justify-between items-center my-1 py-2 px-6 ">
                  <div className="flex flex-row items-center space-x-4 ">
                    <div>
                      <Avatar className="h-[48px] w-[48px] border border-gray-200 dark:border-transparent">
                        <AvatarImage
                          src={
                      ...
                      <div className="ml-auto">
                        {searchResult.isRequested ? (
                          ...
                          <button
                            ...
                            className="px-4 py-2 text-gray-50 rounded-xl bg-accentBg "
